...
|       | Juliette Dubois:  Bayesian inversion for submarine earthquakes using acoustic-gravity waves |
| 15:30 | Coffee break                                                            |
...
Submarine earthquakes are the main cause of tsunamis. Those earthquakes are particularly difficult to measure, and their study relies mainly on proxy data.  Recent works have suggested that the hydroacoustic waves generated by the submarine earthquake can be a useful complement to the seismic waves classically studied.

In this talk, I will present a Bayesian inverse problem for submarine earthquakes using acoustic-gravity waves. I will describe first the forward model that relies on a coupled acoustic-gravity system, then the Bayesian inverse problem. Finally, I will show preliminary results obtained with um-bridge. This is a joint work with A. Reinarz (Durham University) and L. Scarabosio (Radboud University).
